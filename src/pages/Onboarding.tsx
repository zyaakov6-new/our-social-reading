...
import { BookOpen, Users, Trophy, ArrowLeft, ArrowRight, Clock, BookMarked } from "lucide-react";
...
const welcomeScreens = [
  {
    icon: BookOpen,
    title: "ספר ביחד",
    subtitle: "עוקבים אחרי הקריאה, ביחד",
    description: "תעקבו אחרי הרגלי הקריאה שלכם, תבנו רצפים יומיים, ותקראו יותר — ביחד עם חברים.",
  },
  {
    icon: Trophy,
    title: "אתגרו את עצמכם",
    subtitle: "תחרויות קריאה עם חברים",
    description: "צרו אתגרי קריאה, תחרו עם חברים על לוח התוצאות, ושתפו את ההישגים שלכם.",
  },
  {
    icon: Users,
    title: "קראו ביחד",
    subtitle: "הפיד החברתי שלכם",
    description: "ראו מה חברים קוראים, עודדו אחד את השני, ובנו קהילה של קוראים.",
  },
];
...
const Onboarding = () => {
  ...
  const handleFinish = () => {
    ...
    localStorage.setItem(
      "user_profile",
      JSON.stringify({ name, email, goalType, goalValue: parseInt(goalValue) })
    );
    navigate("/");
  };
          ...
          {step < 3 && (
            ...
            >
              <div className="w-24 h-24 rounded-full reading-gradient flex items-center justify-center">
                {(() => {
                  const Icon = welcomeScreens[step].icon;
          ...
          {step === 3 && (
            ...
            >
              <div className="text-center space-y-2">
                <h1 className="text-2xl font-bold text-foreground font-hebrew-serif">
                  בואו נתחיל! 📚
                </h1>
          ...
          {step === 4 && (
            ...
            >
              <div className="text-center space-y-2">
                ...
                <p className="text-muted-foreground">בחרו יעד קריאה יומי</p>
              </div>
              ...
              <div className="space-y-3">
                <Label>
                  {goalType === "minutes" ? "דקות קריאה ביום" : "ספרים בחודש"}
                </Label>
      ...
      <div className="px-6 pb-8 pt-4 flex gap-3">
        ...
        {step === 4 && (
          <Button
            ...
            className="gap-2 px-8 h-12 text-base reading-gradient border-0"
          >
            בואו נתחיל לקרוא! 📖
          </Button>
        )}
